...
namespace Core.Utility
{
  ...
  public class Timer
  {
    ...
    [SerializeField]
    private TransitionGraph m_type;
    ...
    public Timer(float duration = 1, TransitionGraph type = TransitionGraph.Linear)
    {
    ...
    private IEnumerator Routine()
    {
      ...
      while (true) {
        ...
        value = type switch
        {
          TransitionGraph.EaseIn    => t.EaseIn(easePower),
          TransitionGraph.EaseOut   => t.EaseOut(easePower),
          TransitionGraph.EaseInOut => t.EaseInOut(easePower),
          _                   => t,
        };
