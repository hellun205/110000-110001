...
{
  [CustomPropertyDrawer(typeof(CustomCurveTimer))]
  public class CustomCurveTimerEditor : PropertyDrawer
  {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
      ...
      var curveLabelRect = new Rect(position.x + 80, position.y, 40, 18f);
      var curveRect = new Rect(position.x + 120, position.y, position.width - 121, 18f);
      ...
      EditorGUI.LabelField(curveLabelRect, "curve");
      EditorGUI.PropertyField(curveRect, property.FindPropertyRelative("m_curve"), GUIContent.none);
